...
SET_KEY = ['Date', 'Type', 'Transaction ID', 'Contact Phone Number', 'Reference Txn ID', 'Name', 'From Email Address', 'Shipping Address', 'Address 1', 'Item Title', 'New', 'Ship']
set_courier = ['Date', 'Type', 'Transaction ID', 'Contact Phone Number', 'Reference Txn ID', 'Name', 'From Email Address', 'Shipping Address', 'Address 1', 'Item Title', 'New', 'Ship', 'Shipping Courier']
...
def select_ship_one(df):
    ...
    df_all_ship = df_all_ship[SET_KEY]
    return df_all_ship
...
def take_line_two(df):
    ...
    df_two_ago_blank = df_two_ago_blank[[
        'From Email Address', 'Date', 'Type', 'Transaction ID', 'Contact Phone Number', 'Reference Txn ID', 'Name', 'Shipping Address', 'Address 1', 'Item Title']]
