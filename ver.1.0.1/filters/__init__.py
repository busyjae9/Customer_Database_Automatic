...
def select_new(df, df_cus): 
    ...
    df_processed = df.loc[:, ['Date', 'Type', 'Reference Txn ID', 'Name', 'From Email Address', 'Shipping Address', 'Item Title']]
    ...
    df_all = df_all[['Date', 'Type', 'Reference Txn ID', 'Name', 'From Email Address', 'Shipping Address', 'Item Title', 'New']]
    return df_all
...
def select_bi(df_all):
    ...
    bi_people = bi_people[['Date', 'Type', 'Reference Txn ID', 'Name', 'From Email Address', 'Shipping Address', 'Item Title', 'New']]
    ...
    df_all = df_all.sort_values(by='Date')
    df_all = df_all.sort_index()
    df_all_drop = df_all[['Date', 'Type', 'Reference Txn ID', 'Name', 'From Email Address', 'Shipping Address', 'Item Title', 'New']]
    return df_all_drop
